...
<?php $categories = \app\models\Category::find()->all(); ?>
<header id="header">
    <?php
    NavBar::begin([
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            '<form class="form-inline my-2 my-lg-0" method="get" action="' . Url::to(['article/index']) . '">
                 <div class="input-group">
                     <input type="text" class="form-control ml-2" name="ArticleSearch[search]" placeholder="Search...">
            ...
            !Yii::$app->user->isGuest && Yii::$app->user->identity->role == 'ADMIN'
              ? ['label' => 'Control Pannel', 'url' => ['/admin/index']]
              : '',
